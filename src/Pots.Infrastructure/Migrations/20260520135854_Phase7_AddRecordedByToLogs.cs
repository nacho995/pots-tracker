...
GRANT UPDATE (
  ...
  salt_target_reached,
  regular_meals, skipped_breakfast, small_frequent_meals,
  avoided_large_high_carb_meal, adequate_protein, alcohol_avoided, caffeine_level,
  compression_socks, waist_high_compression, abdominal_compression, compression_hours_worn,
  recumbent_exercise, walking, strength, stretching, pt_exercises,
  exercise_duration_minutes, exercise_intensity, post_exercise_symptoms,
  planned_rest_breaks, avoided_overexertion, used_activity_pacing,
  avoided_long_standing, sat_during_shower_cooking, mobility_aid,
